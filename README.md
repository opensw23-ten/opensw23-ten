...
|학습 횟수|데이터 개수|Loss|소요 시간|INPUT|
|:------:|:---:|:---:|:---:|:---:|
|3427회|한글 223개|2.904 -> 0.4316|약 8시간|안녕하세요 제 이름은 건국.|

**안녕하세요 제 이름은 건국. *( 잡음이 많이 섞여 재생됩니다. 유의해주세요. )***
...
- 충분히 학습이 되지 않고 출력된 음성은 많은 잡음이 섞여서 나오게 됨.  
## Installation  
### Requirements
